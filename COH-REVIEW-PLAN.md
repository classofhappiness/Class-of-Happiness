...
- `about.tsx`'s broken link (gap 4) — fix identified, not yet applied to the app itself (frontend code change, distinct from the website HTML draft above); flagging for a decision on when to bundle it in.
