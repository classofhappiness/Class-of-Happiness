...
const styles = StyleSheet.create({
  ...
  roleButton: { borderRadius: 20, paddingVertical: 10, paddingHorizontal: 20, alignItems: 'center', elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 5 },
  ...
  footerSection: { marginTop: 20, alignItems: 'center', paddingBottom: 8 },
