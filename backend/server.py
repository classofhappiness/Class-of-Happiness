...
# Real bug fix Aug 29: a genuine duplicate HELPERS_PT dict used to live here, silently
...
# Real bug fix Aug 29: a genuine duplicate HELPERS_ES dict used to live here, silently
# overwritten by the real one below (Python keeps the later module-level assignment) - dead
# code, never executed, but it carried the exact same scrambled-order bug, so removed rather
# than left as a confusing, also-wrong copy for a future edit to accidentally touch.

# Real bug fix Aug 29: a genuine duplicate HELPERS_FR dict used to live here, silently
# overwritten by the real one below (Python keeps the later module-level assignment) - dead
# code, never executed, but it carried the exact same scrambled-order bug, so removed rather
# than left as a confusing, also-wrong copy for a future edit to accidentally touch.
...
HELPERS_PT = {
    "blue": [
        ...
        {"id":"b2","name":"Beber Água","description":"Bebe uma bebida quente e confortante. Deixa-te aquecer por dentro.","feeling_colour":"blue","icon":"local-cafe","emoji":"☕"},
        {"id":"b3","name":"Música Preferida","description":"Ouve ou canta a tua música favorita. A música pode fazer-nos sentir melhor.","feeling_colour":"blue","icon":"music-note","emoji":"🎵"},
        {"id":"b4","name":"Canto Aconchegante","description":"Encontra um lugar confortável e senta-te ou deita-te por alguns minutos.","feeling_colour":"blue","icon":"home","emoji":"🛋️"},
        {"id":"b5","name":"Contar a Alguém","description":"Fala com alguém em quem confias sobre como te sentes.","feeling_colour":"blue","icon":"chat","emoji":"💬"},
        {"id":"b6","name":"Respiração Lenta","description":"Inspira devagar pelo nariz e expira pela boca. Repete 5 vezes.","feeling_colour":"blue","icon":"air","emoji":"💨"},
    ],
    "green": [
        ...
        {"id":"g3","name":"Experimentar Algo Novo","description":"Experimenta uma atividade ou ideia nova hoje.","feeling_colour":"green","icon":"explore","emoji":"🌟"},
        {"id":"g4","name":"Partilha o Teu Sorriso","description":"Sorri para alguém. Os sorrisos são contagiantes!","feeling_colour":"green","icon":"mood","emoji":"😊"},
        {"id":"g5","name":"Definir um Objetivo","description":"Pensa num objetivo pequeno para hoje. O que queres alcançar?","feeling_colour":"green","icon":"flag","emoji":"🎯"},
        {"id":"g6","name":"Gratidão","description":"Pensa em 3 coisas pelas quais és grato. Isso ajuda-nos a sentir felizes.","feeling_colour":"green","icon":"sentiment-satisfied","emoji":"🙏"},
    ],
    "yellow": [
        ...
        {"id":"y2","name":"Abanar o Corpo","description":"Agita as mãos e o corpo por 30 segundos para libertar a tensão.","feeling_colour":"yellow","icon":"directions-run","emoji":"🕺"},
        {"id":"y3","name":"Conta até 10","description":"Conta devagar até 10. Isto ajuda o teu cérebro a acalmar.","feeling_colour":"yellow","icon":"format-list-numbered","emoji":"🔢"},
        {"id":"y4","name":"5 Sentidos","description":"Nomeia 5 coisas que vês, 4 que tocas, 3 que ouves, 2 que cheiras, 1 que sentes.","feeling_colour":"yellow","icon":"visibility","emoji":"👁️"},
        {"id":"y5","name":"Apertar e Soltar","description":"Aperta os punhos com força e depois solta. Repete 5 vezes.","feeling_colour":"yellow","icon":"pan-tool","emoji":"✊"},
        {"id":"y6","name":"Falar Sobre Isso","description":"Fala com alguém sobre o que te está a preocupar.","feeling_colour":"yellow","icon":"forum","emoji":"🗣️"},
    ],
    "red": [
...
HELPERS_ES = {
    "blue": [
        ...
        {"id":"b2","name":"Bebe Agua","description":"Bebe algo caliente y reconfortante. Deja que te caliente por dentro.","feeling_colour":"blue","icon":"local-cafe","emoji":"☕"},
        {"id":"b3","name":"Canción Favorita","description":"Escucha o canta tu canción favorita. La música puede hacernos sentir mejor.","feeling_colour":"blue","icon":"music-note","emoji":"🎵"},
        {"id":"b4","name":"Rincón Acogedor","description":"Encuentra un lugar cómodo y siéntate o túmbate unos minutos.","feeling_colour":"blue","icon":"home","emoji":"🛋️"},
        {"id":"b5","name":"Díselo a Alguien","description":"Habla con alguien de confianza sobre cómo te sientes.","feeling_colour":"blue","icon":"chat","emoji":"💬"},
        {"id":"b6","name":"Respiración Lenta","description":"Inhala despacio por la nariz y exhala por la boca. Repite 5 veces.","feeling_colour":"blue","icon":"air","emoji":"💨"},
    ],
    "green": [
        ...
        {"id":"g3","name":"Prueba Algo Nuevo","description":"Experimenta con una actividad o idea nueva hoy.","feeling_colour":"green","icon":"explore","emoji":"🌟"},
        {"id":"g4","name":"Comparte tu Sonrisa","description":"Sonríe a alguien. ¡Las sonrisas son contagiosas!","feeling_colour":"green","icon":"mood","emoji":"😊"},
        {"id":"g5","name":"Establecer un Objetivo","description":"Piensa en un pequeño objetivo para hoy. ¿Qué quieres lograr?","feeling_colour":"green","icon":"flag","emoji":"🎯"},
        {"id":"g6","name":"Gratitud","description":"Piensa en 3 cosas por las que estás agradecido. Eso nos ayuda a sentirnos felices.","feeling_colour":"green","icon":"sentiment-satisfied","emoji":"🙏"},
    ],
    "yellow": [
        ...
        {"id":"y2","name":"Sacudir el Cuerpo","description":"Agita las manos y el cuerpo durante 30 segundos para liberar la tensión.","feeling_colour":"yellow","icon":"directions-run","emoji":"🕺"},
        {"id":"y3","name":"Contar hasta 10","description":"Cuenta despacio hasta 10. Esto ayuda a tu cerebro a calmarse.","feeling_colour":"yellow","icon":"format-list-numbered","emoji":"🔢"},
        {"id":"y4","name":"5 Sentidos","description":"Nombra 5 cosas que ves, 4 que tocas, 3 que oyes, 2 que hueles, 1 que sientes.","feeling_colour":"yellow","icon":"visibility","emoji":"👁️"},
        {"id":"y5","name":"Apretar y Soltar","description":"Aprieta los puños con fuerza y luego suéltalos. Repite 5 veces.","feeling_colour":"yellow","icon":"pan-tool","emoji":"✊"},
        {"id":"y6","name":"Hablar de Ello","description":"Habla con alguien sobre lo que te preocupa.","feeling_colour":"yellow","icon":"forum","emoji":"🗣️"},
    ],
    "red": [
...
HELPERS_FR = {
    "blue": [
        ...
        {"id":"b2","name":"Bois de l'Eau","description":"Bois quelque chose de chaud et réconfortant. Laisse-toi réchauffer de l'intérieur.","feeling_colour":"blue","icon":"local-cafe","emoji":"☕"},
        {"id":"b3","name":"Chanson Préférée","description":"Écoute ou chante ta chanson préférée. La musique peut nous aider à aller mieux.","feeling_colour":"blue","icon":"music-note","emoji":"🎵"},
        {"id":"b4","name":"Coin Douillet","description":"Trouve un endroit confortable et assieds-toi ou allonge-toi quelques minutes.","feeling_colour":"blue","icon":"home","emoji":"🛋️"},
        {"id":"b5","name":"Le Dire à Quelqu'un","description":"Parle à quelqu'un en qui tu as confiance de ce que tu ressens.","feeling_colour":"blue","icon":"chat","emoji":"💬"},
        {"id":"b6","name":"Respiration Lente","description":"Inspire lentement par le nez et expire par la bouche. Répète 5 fois.","feeling_colour":"blue","icon":"air","emoji":"💨"},
    ],
    "green": [
        ...
        {"id":"g3","name":"Essayer Quelque Chose de Nouveau","description":"Expérimente une nouvelle activité ou idée aujourd'hui.","feeling_colour":"green","icon":"explore","emoji":"🌟"},
        {"id":"g4","name":"Partage ton Sourire","description":"Souris à quelqu'un. Les sourires sont contagieux!","feeling_colour":"green","icon":"mood","emoji":"😊"},
        {"id":"g5","name":"Fixer un Objectif","description":"Pense à un petit objectif pour aujourd'hui. Qu'est-ce que tu veux accomplir?","feeling_colour":"green","icon":"flag","emoji":"🎯"},
        {"id":"g6","name":"Gratitude","description":"Pense à 3 choses dont tu es reconnaissant. Cela nous aide à nous sentir heureux.","feeling_colour":"green","icon":"sentiment-satisfied","emoji":"🙏"},
    ],
    "yellow": [
        ...
        {"id":"y2","name":"Secouer le Corps","description":"Agite tes mains et ton corps pendant 30 secondes pour libérer la tension.","feeling_colour":"yellow","icon":"directions-run","emoji":"🕺"},
        {"id":"y3","name":"Compter jusqu'à 10","description":"Compte lentement jusqu'à 10. Cela aide ton cerveau à se calmer.","feeling_colour":"yellow","icon":"format-list-numbered","emoji":"🔢"},
        {"id":"y4","name":"5 Sens","description":"Nomme 5 choses que tu vois, 4 que tu touches, 3 que tu entends, 2 que tu sens, 1 que tu ressens.","feeling_colour":"yellow","icon":"visibility","emoji":"👁️"},
        {"id":"y5","name":"Serrer et Relâcher","description":"Serre les poings fort puis relâche. Répète 5 fois.","feeling_colour":"yellow","icon":"pan-tool","emoji":"✊"},
        {"id":"y6","name":"En Parler","description":"Parle à quelqu'un de ce qui te préoccupe.","feeling_colour":"yellow","icon":"forum","emoji":"🗣️"},
    ],
    "red": [
...
HELPERS_HI = {
    "blue": [
        ...
        {"id":"b2","name":"पानी पियो","description":"गर्म पानी पिएं। यह आपको अंदर से गर्माहट देगा।","feeling_colour":"blue","icon":"local-cafe","emoji":"☕"},
        ...
        {"id":"b5","name":"किसी को बताओ","description":"किसी भरोसेमंद व्यक्ति को बताएं कि आप कैसा महसूस कर रहे हैं।","feeling_colour":"blue","icon":"chat","emoji":"💬"},
        {"id":"b6","name":"धीमी सांस लेना","description":"नाक से धीरे-धीरे सांस लें और मुंह से छोड़ें। 5 बार दोहराएं।","feeling_colour":"blue","icon":"air","emoji":"💨"},
    ],
    "green": [
        {"id":"g1","name":"आगे बढ़ते रहो!","description":"आप बहुत अच्छा कर रहे हैं! ऐसे ही करते रहें।","feeling_colour":"green","icon":"star","emoji":"⭐"},
        {"id":"g2","name":"दोस्त की मदद करो","description":"किसी को अपनी मदद की पेशकश करें। दूसरों की मदद करने से हमें अच्छा महसूस होता है।","feeling_colour":"green","icon":"favorite","emoji":"❤️"},
        {"id":"g3","name":"कुछ नया आज़माओ","description":"आज एक नई गतिविधि या विचार आज़माएं।","feeling_colour":"green","icon":"explore","emoji":"🌟"},
        {"id":"g4","name":"अपनी मुस्कान बांटो","description":"किसी को देखकर मुस्कुराएं। मुस्कान संक्रामक होती है!","feeling_colour":"green","icon":"mood","emoji":"😊"},
        {"id":"g5","name":"एक लक्ष्य बनाओ","description":"आज के लिए एक छोटा लक्ष्य सोचें। आप क्या हासिल करना चाहते हैं?","feeling_colour":"green","icon":"flag","emoji":"🎯"},
        {"id":"g6","name":"शुक्रगुज़ार होना","description":"3 चीज़ों के बारे में सोचें जिनके लिए आप आभारी हैं। यह हमें खुश महसूस करने में मदद करता है।","feeling_colour":"green","icon":"sentiment-satisfied","emoji":"🙏"},
    ],
    "yellow": [
        {"id":"y1","name":"बबल सांस","description":"साबुन के बुलबुले उड़ाने की कल्पना करें। गहरी सांस लें और धीरे-धीरे छोड़ें।","feeling_colour":"yellow","icon":"bubble-chart","emoji":"🫧"},
        {"id":"y2","name":"शरीर हिलाओ","description":"तनाव दूर करने के लिए 30 सेकंड तक अपने हाथ और शरीर हिलाएं।","feeling_colour":"yellow","icon":"directions-run","emoji":"🕺"},
        {"id":"y3","name":"10 तक गिनो","description":"धीरे-धीरे 1 से 10 तक गिनें। यह आपके दिमाग को शांत करने में मदद करता है।","feeling_colour":"yellow","icon":"format-list-numbered","emoji":"🔢"},
        ...
        {"id":"y5","name":"दबाओ और छोड़ो","description":"अपनी मुट्ठियों को कसकर दबाएं फिर छोड़ दें। 5 बार दोहराएं।","feeling_colour":"yellow","icon":"pan-tool","emoji":"✊"},
        {"id":"y6","name":"इसके बारे में बात करो","description":"किसी भरोसेमंद वयस्क को बताएं कि आपको क्या परेशान कर रहा है।","feeling_colour":"yellow","icon":"forum","emoji":"🗣️"},
    ],
    "red": [
        ...
        {"id":"r3","name":"उल्टी गिनती गिनो","description":"धीरे-धीरे 10 से 1 तक गिनें। यह आपके दिमाग को शांत करता है।","feeling_colour":"red","icon":"timer","emoji":"⏱️"},
        ...
        {"id":"r5","name":"मदद मांगो","description":"किसी भरोसेमंद वयस्क को बताएं कि आपको अभी मदद चाहिए।","feeling_colour":"red","icon":"support-agent","emoji":"🆘"},
        {"id":"r6","name":"खुद को गले लगाओ","description":"खुद को गले लगाएं। अपनी बाहों को क्रॉस करें और धीरे से दबाएं।","feeling_colour":"red","icon":"favorite","emoji":"🤗"},
    ],
}
